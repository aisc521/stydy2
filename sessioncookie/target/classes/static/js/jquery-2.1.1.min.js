...
function layboxs(url){
	...
	$("#mask_bg").fadeTo(100, 0.6);
	$("#ajax_content").html('<div id="mask_op_div"><a id="maskoparet" href="javascript:;" onclick="closemask()"><i></i></a></div><iframe src="'+url+'" id="iframebox" width="0" height="0" frameborder="0" scrolling="auto" /></iframe>');
	$("#mask_op_div").hide();
